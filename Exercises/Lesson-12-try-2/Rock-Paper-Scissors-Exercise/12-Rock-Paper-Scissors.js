  ...
  */
  ...
  let intervalID;      
  const buttonState = document.querySelector('.js-auto-play-button')
  ...
  function resetScore () {
    const confirmation = document.querySelector('.js-reset-confirmation')
    confirmation.innerHTML = `Are you SURE you want to reset the score? <button class="js-yes-button">YES</button> <button class="js-no-button">NO</button>`
